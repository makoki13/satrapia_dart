...
class Cantera extends Edificio {
  ...
  Cantera (this._id, this._nombre, this._capital, this._disp) :  super (_id, _nombre, TipoEdificio.CANTERA_DE_PIEDRA, _capital.getPosicion(),
    ...
    this.almacen = new Almacen ( 68, 'Cantera de piedra', PIEDRA, this._capital.getPosicion(), Parametros.Cantera_Almacen_Capacidad);
